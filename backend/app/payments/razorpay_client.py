...
class RazorpayService:
    def __init__(self) -> None:
        # Strictly enforce Test Mode — live keys are forbidden
    ...
    def create_order(self, amount_paise: int, receipt: str, notes: dict | None = None) -> dict:
        ...
        try:
            ...
            raise RazorpayClientError(f"Failed to create order: {e!s}") from e
    ...
    def fetch_order(self, order_id: str) -> dict:
        ...
        try:
            ...
            raise RazorpayClientError(f"Failed to fetch order: {e!s}") from e

    def fetch_orders_by_receipt(self, receipt_id: str) -> list:
        """
        Fetches orders matching the provided receipt ID.
        ...
        try:
            ...
            raise RazorpayClientError(f"Failed to fetch orders by receipt: {e!s}") from e
